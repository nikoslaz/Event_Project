...
public class LoadClients extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            EditClientTable editClients = new EditClientTable();
            ArrayList<Client> clients = editClients.getClients(type);
            ...
            Logger.getLogger(LoadClients.class.getName()).log(Level.SEVERE, null, e);
